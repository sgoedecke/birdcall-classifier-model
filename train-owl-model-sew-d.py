...
from transformers import AutoFeatureExtractor, AutoConfig, AutoModelForSequenceClassification, SEWDForSequenceClassification
import evaluate
...
feature_extractor = AutoFeatureExtractor.from_pretrained("asapp/sew-d-tiny-100k-ft-ls100h")
...
model = AutoModelForAudioClassification.from_pretrained(
    "asapp/sew-d-tiny-100k-ft-ls100h", num_labels=num_labels, label2id=label2id, id2label=id2label#, config=config
)

training_args = TrainingArguments(
    output_dir="wav2vec2_owl_classifier_sew_d", # this will also be the name of the HF model
